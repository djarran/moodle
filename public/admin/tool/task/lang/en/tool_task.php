...
$string['eventscheduledtaskupdated_desc'] = 'The user with id \'{$a->userid}\' updated the scheduled task \'{$a->classname}\'. New settings: minute=\'{$a->minute}\', hour=\'{$a->hour}\', day=\'{$a->day}\', month=\'{$a->month}\', dayofweek=\'{$a->dayofweek}\', status=\'{$a->status}\'.';
...
$string['taskenabled'] = 'Task enabled';
